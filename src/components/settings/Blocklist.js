    ...
    <div className="w-full max-w-3xl">
      ...
      <div className="flex items-start justify-between gap-3 mb-6">
        ...
        <button
          ...
          className="shrink-0 px-3 py-2 bg-[#D63B1F] hover:bg-[#c23119] text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
          </svg>
          <span className="hidden sm:inline">Block a number</span>
        ...
        <div className="bg-[#FFFFFF] border border-[#E3E1DB] rounded-lg p-4 mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="flex-1 px-3 py-2.5 text-sm border border-[#D4D1C9] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D63B1F]/20 focus:border-[#D63B1F]"
              autoFocus
            />
      ...
      <div className="bg-[#FFFFFF] border border-[#E3E1DB] rounded-lg">
        ...
        {loading ? (
          ...
          <>
            {/* Column headers */}
            <div className="hidden sm:grid grid-cols-[1fr_1fr_100px] px-5 py-2.5 border-b border-[#E3E1DB] bg-[#F7F6F3]/50 rounded-none">
            ...
            {filtered.map((item) => (
              <div
                key={item.id}
                className="flex sm:grid sm:grid-cols-[1fr_1fr_100px] items-center px-5 py-3.5 border-b border-[#EFEDE8] last:border-0 hover:bg-[#F7F6F3] gap-3"
              >
                <span className="text-sm text-[#131210] font-medium flex-1">{item.phone_number}</span>

                <div className="hidden sm:flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-[#EFEDE8] flex items-center justify-center shrink-0">
