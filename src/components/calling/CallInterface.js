...
export default function CallInterface({
  ...
  // Top-left header shows ONLY one thing per the spec:
  //   • the line's custom_name if set in Settings → Phone Numbers
  //   • otherwise the formatted line number
  // Prefer the toName the hook already computed (it has a single-number
  // fallback for when Telnyx omits destination_number); local match against
  // phoneNumbers is a secondary fallback.
